...
export default function DocumentViewer() {
  ...
  return (
    <>
      <div className="min-h-screen lg:h-screen orion-bg flex flex-col lg:flex-row w-full overflow-hidden">
        <aside className="w-full lg:w-[220px] shrink-0 bg-[#0A1628] border-b lg:border-b-0 lg:border-r border-border/20 flex flex-col h-auto lg:h-full overflow-hidden">
        ...
        <aside className="w-full lg:w-[360px] shrink-0 bg-background/95 border-t lg:border-t-0 lg:border-l border-border/20 flex flex-col h-auto lg:h-full overflow-hidden order-2 lg:order-none">
