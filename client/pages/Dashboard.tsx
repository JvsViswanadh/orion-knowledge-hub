  ...
  const initialDocs = [
    {
      ...
      description: "The market showed strong growth in the tech sector, with a notable increase in AI investments. Consumer spending remained steady, but inflation concerns persist. Key trends include the rise of decentralized finance and..."
    },
    {
      id: 2,
    ...
    <div className="min-h-screen orion-bg">
      ...
      <header className="w-full px-6 py-4 flex justify-between items-center border-b border-border/20">
        <div className="flex items-center">
          ...
          <span className="text-xl font-semibold text-foreground">Orion Hub</span>
        </div>
      ...
      <main className="px-6 py-8">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[400px,1fr] gap-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">Upload Zone</h2>
            <Card className="bg-card/60 backdrop-blur border-border/60 border-2 border-dashed">
              <CardContent className="p-8">
                <div className="text-center space-y-4">
                  ...
                  <div>
                    <p className="text-lg font-medium text-foreground mb-1">Drag & Drop Files Here</p>
                  ...
                  <div className="pt-4 border-t border-border/40">
                    <p className="text-xs text-muted-foreground">
                      Currently supported file types: PDF, DOCX, Word, Formats (XLSX), 
                      TXT, Transcripts (Coming Soon)
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-semibold text-foreground">Document Library</h2>
            <div className="space-y-4">
              {documents.map((doc) => (
                <Card key={doc.id} className="bg-card/60 backdrop-blur border-border/60 hover:bg-card/80 transition-colors">
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button aria-label="Delete document" onClick={() => handleDelete(doc.id)} variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-destructive">
